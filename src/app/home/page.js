        ...
        <div className="max-w-[952px] mx-auto">
          <div className="py-[40px] 2xl:py-[60px] 3xl:py-[120px]">
            ...
            <form
              className={`${
                images.length > 0
                  ...
                  : "rounded-[15px] pt-3 smd:pt-6 3xl:pt-10"
              } bg-[#F2F2F2] pb-3 smd:pb-6 3xl:pb-10 pl-[45px] pr-[20px] md:px-[45px] 3xl:px-[75px] relative`}
            >
              <label className="relative">
                <input
                  className="bg-white rounded-[10px] 3xl:rounded-[15px] w-full text-black h-[46px] 3xl:h-[82px] font-normal text-[15px] 3xl:text-[20px] placeholder:text-[#9E9E9E] placeholder:font-normal placeholder:text-[15px] 3xl:placeholder:text-[20px] pl-5 pr-[60px] md:pr-20 outline-none"
                  type="text"
                  name="text"
                  id="text"
            ...
            <Link
              ...
              className="font-medium text-[18px] 3xl:text-[25px] text-white bg-[#EA0056] hover:bg-[#d2034f] transition cursor-pointer rounded-lg w-fit text-center 4xl:w-full  py-3 3xl:py-5 px-14 mx-auto table"
            >
