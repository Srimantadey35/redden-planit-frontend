      ...
      <div className="container">
        <div className="py-[40px] 2xl:py-[120px]">
          <h3 className="text-center font-medium text-[27px] 2xl:text-[30px] text-[#151515]">
            Hi{" "}
            <span className="text-black text-[44px] 3xl:text-[50px]" style={{fontFamily:'allura-font'}}>
              Rabina
            </span>
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[16px] lg:gap-[24px] xl:gap-[40px] mt-8 sm:mt-12 md:mt-16 2xl:mt-[75px]">
            {cardData.map((item, index) => (
              <div key={index} className="bg-[#F7F7F7] rounded-2xl p-[28px] xl:p-[50px] hover:scale-[1.03] transition ease-in-out duration-300 hover:shadow-xl flex flex-col">
