                ...
                <div className="space-y-[25px] bg-[#F2F2F2] px-[30px] 3xl:px-[60px] py-9 rounded-[10px] mb-[24px]">
                  ...
                  <div>
                    ...
                    <div className="space-y-[25px]">
                      ...
                      {selectedCategory === "bridalmakeup" && <BridalMakeup defaultValues={categoryForms["bridalmakeup"] || {}} onDataChange={setCategoryData} />}
                      {selectedCategory === "decorators" && <Decorators defaultValues={categoryForms["decorators"] || {}}  onDataChange={setCategoryData} />}
              ...
              <div className="space-y-[25px] bg-[#F2F2F2] px-[30px] py-6 rounded-[10px] mb-[20px]">
                ...
                <div className="flex flex-col w-full mr-[25px]">
                 ...
                 <div className="flex items-center mt-2 justify-end">
                   {portfolioButton && (<button type="submit" className="cursor-pointer font-semibold text-[16px] 4xl:text-[20px] bg-[#EA0056] hover:bg-[#d6004f] rounded-[8px] py-2 4xl:py-3.5 px-[20px]">
                     Save & Publish
                  </button>)}
            </div>
              </div>
