        ...
        <div className="py-[40px] 2xl:py-[120px] flex items-stretch">
          <div className="bg-[#F7F7F7] p-[40px] 2xl:p-[60px] rounded-2xl w-[65%] 3xl:w-[914px]">
            ...
            <form className="space-y-[30px]">
              ...
              <button className="cursor-pointer transition font-semibold text-[20px] text-white py-3.5 bg-[#EA0056] hover:bg-[#c9004a] rounded-lg w-[317px] mx-auto table">
                Add to list
              </button>
            </form>
          </div>
          <div className="bg-[#F7F7F7] p-[40px] 2xl:p-[60px] rounded-2xl w-[35%] 3xl:w-[calc(100%-914px)] ml-[30px] 3xl:ml-[40px] flex flex-col">
            ...
            >
              ...
              <button
                type="submit"
                className="cursor-pointer mt-auto font-semibold text-[20px] text-white py-3.5 bg-[#EA0056] hover:bg-[#c9004a] transition rounded-lg w-[317px] mx-auto table"
              >
                Submit all
              </button>
            </form>
