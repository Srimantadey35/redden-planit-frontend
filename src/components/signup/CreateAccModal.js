              ...
              <p className="mt-3 text-[#505050] text-sm sm:text-base 3xl:text-lg">
                {planName === "Vendor" ? (
                  ...
                  <>
                    ...
                    <br className="hidden 3xl:block" /> manage every detail
                    effortlessly.
                  </>
                )}
              </p>
              ...
              <div className="input-wrap mb-5 relative">
                ...
                >
                  <Image
                    width={18}
                    height={18}
                    src={`${isPassVisible.pass ? '/images/eye-open.svg':'/images/sign-up/passvisible.svg'}`}
                    alt="passvisible"
                  />
                </button>
              </div>
                ...
                <div className="relative">
                  ...
                  >
                    <Image
                      width={18}
                      height={18}
                      src={`${isPassVisible.CPass ? '/images/eye-open.svg':'/images/sign-up/passvisible.svg'}`}
                      alt="passvisible"
                    />
                  </button>
                </div>
